...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    subItems: [
      { name: "Manage News", path: "/news/all" },
    ],
  },
  {
    icon: <ListIcon />,
  ...
  {
    icon: <PageIcon />,
    name: "Shorts / Quick News",
    subItems: [
      { name: "All Shorts", path: "/shorts/all-shorts" , pro: false},
      { name: "Add Short", path: "/shorts/add-shorts", pro: false },
    ],
  },
  {
    icon: <BoxCubeIcon />,
    name: "E-paper & Media",
    subItems: [
      { name: "Manage E-paper", path: "/epaper" },
    ],
  },
  {
    icon: <PlugInIcon />,
  ...
  },
  {
    ...
    name: "Notifications",
    subItems: [
      { name: "Push Notifications", path: "/notifications" },
    ],
  },
  {
    icon: <PieChartIcon />,
