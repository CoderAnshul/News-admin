...
import { updateArticle, fetchArticles } from '../../../store/slices/articles';
...
const EditArticles = () => {
  ...
  useEffect(() => {
    if (id && articles.length > 0) {
      ...
      if (article) {
        setForm({
          coloredHeading: article.coloredHeading || '',
          restHeading: article.restHeading || '',
          articleTitle: article.articleTitle || '',
          category: typeof article.category === 'object' && article.category !== null
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setTimeout(() => {
        ...
        navigate('/articles'); // redirect after success
      }, 2000);
    } catch (err) {
          ...
          <div className="fixed top-4 right-4 bg-green-500 text-white px-6 py-4 rounded-xl shadow-lg z-50 animate-in slide-in-from-right-5 duration-300">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm opacity-90">Article updated successfully</p>
              </div>
              <button
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-2xl">
              <div className="flex flex-col items-center space-y-4">
                ...
                <div className="text-center">
                  <p className="text-lg font-semibold text-gray-900 dark:text-white">Updating Article</p>
                  <p className="text-sm text-gray-600 dark:text-gray-300">Please wait while we process your update...</p>
                </div>
              </div>
            </div>
          </div>
